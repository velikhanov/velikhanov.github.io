<header>
	...
	<div class="sidebar-main">
		...
		<div class="sidebar">
			...
			<a href="/dynamicportfolio.com/skills.php"><i class="fas fa-code"></i><b data-phrase-id="myskills">My skills</b></a>
			<a href="/dynamicportfolio.com/works.php"><i class="fas fa-briefcase"></i><b data-phrase-id="myworks">My works</b></a>
			<a href="/dynamicportfolio.com/form.php"><i class="fas fa-envelope"></i><b data-phrase-id="contactme">Contact me</b></a>
		</div>
		<div class="lang">
			<a class="twlang"><img onclick="languative.changeLanguage('en');" src="img/lang/en.png" alt="English flag"></a>
			<a class="twlang"><img onclick="languative.changeLanguage('az');" src="img/lang/az.png" alt="Azerbaijani flag"></a>
