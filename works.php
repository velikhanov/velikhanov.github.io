  ...
  <body>
    ...
    <section>
      ...
      <ul class="row gallery">
        <!-- Begining -->
          <li class="atyrauG">
            <a href="img/works/full/atyrau_1.jpg" data-caption="<a data-phrase-id='githubRespository' class='galleryLink' href='https://github.com/velikhanov/construct_company_website' target='_blank'><i class='fab fa-github'></i>GitHub</a>">
        ...
        <!-- Begining -->
          <li class="nurayG">
            <a href="img/works/full/nuray_1.jpg" data-caption="<a class='galleryLink' href='https://github.com/velikhanov/NurayHouse' target='_blank'><i class='fab fa-github'></i>GitHub</a>">
        ...
        <!-- Begining -->
          <li class="employeesG">
            <a href="img/works/full/employee_1.jpg" data-caption="<a class='galleryLink' href='https://github.com/velikhanov/emloyees' target='_blank'><i class='fab fa-github'></i>GitHub</a>">
        ...
        <!-- Begining -->
          <li class="comfortG">
            <a href="img/works/full/comfort_1.jpg" data-caption="<a class='galleryLink' href='https://github.com/velikhanov/e-commerce' target='_blank'><i class='fab fa-github'></i>GitHub</a>">
        ...
        <!-- End -->
          <li class="blogG">
            <a href="img/works/full/blog_1.jpg" data-caption="<a class='galleryLink' href='https://github.com/velikhanov/blog' target='_blank'><i class='fab fa-github'></i>GitHub</a>">
