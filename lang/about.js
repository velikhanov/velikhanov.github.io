languative.modifyDictionary("en", {
    ...
    education: "Education",
    phd: "PhD - Inf. Sys. Eng.",
    master: "Master - App. Software",
    bachelor: "Bachelor - Comp. Eng.",
    present: "present",
    languages: "Languages",
    ua: "Ukrainian",
    en: "English",
...
languative.modifyDictionary("az", {
    ...
    master: "Master - Tətbiqi P.T.",
    bachelor: "Bakalavr - Komp. Müh.",
    present: "hal-hazırda",
    languages: "Dillər",
    ua: "Ukrayna dili",
    en: "İngilis dili",
...
languative.modifyDictionary("ru", {
    ...
    master: "Магистр - Прикл. ПО",
    bachelor: "Бакалавр - Комп. инж.",
    present: "наст. время",
    languages: "Языки",
    ua: "Украинский",
    en: "Английский",
